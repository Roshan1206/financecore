package com.financecore.account.config.security;
...
public class ActuatorSecurityConfig {
    ...
    /**
     * Defining filter chain for actuator endpoints
     */
    @Order(1)
    @Bean
    ...
    /**
     * Creating user with desired username/password only for actuator endpoints
     */
