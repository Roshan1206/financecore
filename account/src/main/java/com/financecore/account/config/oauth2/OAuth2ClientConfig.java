package com.financecore.account.config.oauth2;
...
public class OAuth2ClientConfig {
     ...
     */
    @Bean
    public OAuth2AuthorizedClientManager oAuth2AuthorizedClientProvider(ClientRegistrationRepository clientRegistrationRepository,
